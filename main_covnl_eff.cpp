...
int main(int argc, const char * argv[])
{
    ...
    for (int i = 0; i < 100; i++)
    {
        snprintf(logFileName, sizeof(char) * 200,"%s/log/log_covnl_eff-%d.txt.%d", currentDirectory, NUM_FILES, i);
...
//        }
    ...
    char fName[200];
    snprintf(fName, sizeof(char) * 200,"%s/cov/covnl-%d.cov", currentDirectory, dim);
